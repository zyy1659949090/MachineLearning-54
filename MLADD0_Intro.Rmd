...
- [Classification and Regression Trees (CART)](MLADD1_decision-trees.ipynb)

- [Random Forests (RF)](MLADD2_random-forest.ipynb)

- [Gradient Boosting Machines (GBM)](MLADD3_gradient-boosting-machines.ipynb)

- [Generalized Linear Models (GLM)](MLADD4_generalized-linear-models.ipynb)

- [Deep Neural Networks (DNN)](MLADD5_deep-neural-networks.ipynb)

- [Stacking / Super Learner (SL)](MLADD6_stacking.ipynb)
