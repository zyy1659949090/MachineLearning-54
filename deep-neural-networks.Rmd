...
![Alt text](./images/mlp_network.png "Multilayer Perceptron (MLP)") Image Souce: neuralnetworksanddeeplearning.com
...
There are a number of Tw  itter bots that are created using LSTMs.  Some fun examples are [@DeepDrumpf](https://twitter.com/DeepDrumpf) and [@DeepLearnBern](https://twitter.com/DeepLearnBern) by [Brad Hayes](https://twitter.com/hayesbh) from MIT.
